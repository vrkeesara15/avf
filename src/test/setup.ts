...
// This setup is for the jsdom (client) test environment only. When it is
// evaluated in a Node environment (e.g. shared config resolution during the
// server test run), bail out so it stays a harmless no-op.
